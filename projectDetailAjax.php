...
@media (max-width:768px) {
  ...
  <div style="max-width:1200px;margin:0 auto;
      ...
      <div>
        ...
        <div style="position:relative;border-radius:14px;overflow:visible;box-shadow:0 10px 30px rgba(0,0,0,.15);">

          <button onclick="prevImage()" class="proj-arrow prev" aria-label="Previous image">❮</button>

          <img id="mainProjectImg" src="<?php echo htmlspecialchars($mainImg); ?>" style="width:100%;height:65vh;object-fit:cover;display:block;">

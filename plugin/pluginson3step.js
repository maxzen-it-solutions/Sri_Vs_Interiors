...
$("form#subscribe").submit(function() {
    ...
    if ($(".subscribfield").each(function() {
        if ("" == jQuery.trim($(this).val()))
            ...
            $(this).parent().append('<span class="subscribeerror">Please fill your email</span>'),
            $(this).addClass("inputError"),
            s = !0;
        else if ($(this).hasClass("subscribeemail")) {
            var e = /^([\w-\.]+@([\w-]+\.)+[\w-]{2,4})?$/;
            e.test(jQuery.trim($(this).val())) || ($(this).prev("label").text(),
            $(this).parent().append('<span class="subscribeerror">Please fill valid email</span>'),
            $(this).addClass("inputError"),
            s = !0)
        }
    }),
...
(function(e) {
    ...
    w.prototype = {
        ...
        open: function(n) {
            ...
            t.bgOverlay || (t.bgOverlay = k("bg").on("click" + v, function() {
                t.close()
            }),
...
!function(t, e) {
    ...
    function r(t) {
        ...
        return e || h("Style returned " + e + ". Are you running this code in a hidden iframe on Firefox? See http://bit.ly/getsizebug1"),
        e
    }
    function o() {
        if (!u) {
            ...
            i.appendChild(e);
            var o = r(e);
            n.isBoxSizeOuter = d = 200 == t(o.width),
            i.removeChild(e)
        }
    }
    function n(e) {
    ...
    , a = ["paddingLeft", "paddingRight", "paddingTop", "paddingBottom", "marginLeft", "marginRight", "marginTop", "marginBottom", "borderLeftWidth", "borderRightWidth", "borderTopWidth", "borderBottomWidth"], g = a.length, u = !1;
    return n
});
!function(e, t) {
    "use strict";
...
!function(e, t) {
    "function" == typeof define && define.amd ? define(["get-size/get-size", "outlayer/outlayer"], t) : "object" == typeof module && module.exports ? module.exports = t(require("get-size"), require("outlayer")) : (e.Isotope = e.Isotope || {},
    ...
    i.create = function(e, t) {
        ...
        return s.prototype = Object.create(o),
...
!function(t, o) {
    "function" == typeof define && define.amd ? define(["outlayer/outlayer"], o) : "object" == typeof module && module.exports ? module.exports = o(require("outlayer")) : (t.Isotope = t.Isotope || {},
...
!function(t, i) {
    ...
    e.prototype._getItemLayoutPosition = function(t) {
        ...
        for (var h = this._getColGroup(o), s = Math.min.apply(Math, h), n = h.indexOf(s), r = {
            x: this.columnWidth * n,
            y: s
        }, a = s + t.size.outerHeight, u = this.cols + 1 - h.length, l = 0; u > l; l++)
            this.colYs[n + l] = a;
        return r
    }
    ,
    ...
    e.prototype._manageStamp = function(t) {
        ...
        for (var u = this._getOption("originTop"), l = (u ? o.top : o.bottom) + e.outerHeight, c = r; a >= c; c++)
...
!function(t, e) {
    ...
    o._getItemLayoutPosition = function(t) {
        ...
        for (var r = this._getRowGroup(o), s = Math.min.apply(Math, r), h = r.indexOf(s), a = {
            x: s,
            y: this.rowHeight * h
        }, n = s + t.size.outerWidth, u = this.rows + 1 - r.length, g = 0; u > g; g++)
            this.rowXs[h + g] = n;
        return a
    }
    ,
    ...
    o._manageStamp = function(e) {
        ...
        for (var n = (this._getOption("originLeft") ? o.left : o.right) + i.outerWidth, u = h; a >= u; u++)
...
!function(t, i) {
    ...
    g._setRectSize = function(i, e) {
        var s = t(i)
          , r = s.outerWidth
          , h = s.outerHeight;
        (r || h) && (r = this._applyGridGutter(r, this.columnWidth),
    ...
    g.updateShiftTargets = function(t) {
        ...
        this.stamps.forEach(function(t) {
            ...
            if (!r || !r.isPlacing) {
                ...
                this._setRectSize(t, a),
                this.shiftPacker.placed(a)
            }
        }, this);
    ...
    g.itemDragMove = function(t, i, e) {
        ...
        if (r) {
            ...
            var h = this
              , a = new Date;
            this._itemDragTime && a - this._itemDragTime < c ? (clearTimeout(this.dragTimeout),
            this.dragTimeout = setTimeout(s, c)) : (s(),
            this._itemDragTime = a)
        }
    }
    ,
...
!function(e) {
    ...
    "undefined" != typeof exports ? e(exports) : r && (r.hljs = e({}),
    "function" == typeof define && define.amd && define([], function() {
        return r.hljs
    }))
}(function(e) {
    ...
    function c(e) {
        ...
        if (c += e.parentNode ? e.parentNode.className : "",
    ...
    function o(e) {
        ...
        return function n(e, a) {
            for (var c = e.firstChild; c; c = c.nextSibling)
                3 == c.nodeType ? a += c.nodeValue.length : 1 == c.nodeType && (r.push({
                    event: "start",
                    offset: a,
                    node: c
                }),
                a = n(c, a),
                t(c).match(/br|hr|img|input/) || r.push({
                    event: "stop",
                    offset: a,
                    node: c
                }));
    ...
    function s(e, n, a) {
        ...
        for (var u = 0, l = "", f = []; e.length || n.length; ) {
            var b = c();
            if (l += r(a.substr(u, b[0].offset - u)),
            u = b[0].offset,
            b == e) {
                f.reverse().forEach(o);
                do
    ...
    function u(e) {
        ...
        function n(a, c) {
            if (!a.compiled) {
                ...
                a.lR = t(a.l || /\w+/, !0),
                c && (a.bK && (a.b = "\\b(" + a.bK.split(" ").join("|") + ")\\b"),
                a.b || (a.b = /\B|\b/),
                a.bR = t(a.b),
                a.e || a.eW || (a.e = /\B|\b/),
                a.e && (a.eR = t(a.e)),
    ...
    function l(e, t, a, c) {
        ...
        function v(e, r) {
            ...
            if (n) {
                ...
                do
                    ...
                    C = C.parent;
                while (C != n.parent);
                return n.starts && m(n.starts, ""),
                a.rE ? 0 : r.length
            }
            if (s(r, C))
                throw new Error('Illegal lexeme "' + r + '" for mode "' + (C.cN || "<unnamed>") + '"');
            return k += r,
            r.length || 1
        }
        var N = E(e);
        ...
        var k = ""
          , A = 0;
        try {
            for (var S, B, L = 0; C.t.lastIndex = L,
            S = C.t.exec(t),
            S; )
                B = v(t.substr(L, S.index - L), S[0]),
                L = S.index + B;
            for (v(t.substr(L)),
            M = C; M.parent; M = M.parent)
                M.cN && (x += "</span>");
            return {
                r: A,
                value: x,
...
ID.modules.notification = function(t) {
    ...
    var o, s = document.documentElement, c = "string" == typeof s.style.transition ? "transition" : "WebkitTransition";
...
!function() {
    ...
    t.prototype.onscroll = function() {
        ...
        t !== this.isFixed && (this.element.classList.toggle("is-fixed"),
        this.isFixed = t)
    }
    ,
    i(t, "onscroll", 50)
...
ID.modules.destroy = function(o) {
    ...
    t.find(".toggle-button").on("click", function() {
        s ? n.isotope("destroy") : n.isotope(i),
        s = !s
    })
}
;
...
function(t, e, o) {
    var i = {
        ...
        loadContent: function() {
            ...
            "string" == typeof i.options.jsonPath ? (o = i.options.jsonPath,
            t.getJSON(o, e)) : i.logIn()
        },
        logIn: function() {
            var t = this;
            t.$elem.data({
        ...
        setVars: function() {
            var t = this;
            return 0 === t.$elem.children().length ? !1 : (t.baseClass(),
            t.eventTypes(),
        ...
        response: function() {
            var o, i, n = this;
            return n.options.responsive !== !0 ? !1 : (i = t(e).width(),
            n.resizer = function() {
                t(e).width() !== i && (n.options.autoPlay !== !1 && e.clearInterval(n.autoPlayInterval),
                e.clearTimeout(o),
        ...
        loops: function() {
            ...
            e = 0; e < n.itemsAmount; e += 1)
                ...
                n.options.scrollPerPage === !0 && (o = t(n.$owlItems[e]),
                i = o.data("owl-roundPages"),
                i !== s && (n.pagesInArray[s] = n.positionsInArray[e],
                s = i))
        },
        ...
        updatePagination: function() {
            ...
            n = 0; n < r.itemsAmount; n += 1)
                n % r.options.items === 0 && (e += 1,
        ...
        checkNavigation: function() {
            var t = this;
            return t.options.navigation === !1 ? !1 : void (t.options.rewindNav === !1 && (0 === t.currentItem && 0 === t.maximumItem ? (t.buttonPrev.addClass("disabled"),
        ...
        next: function(t) {
            ...
            e.currentItem > e.maximumItem + (e.options.scrollPerPage === !0 ? e.options.items - 1 : 0)) {
        ...
        prev: function(t) {
            ...
            if (e.isTransition)
                return !1;
            if (e.options.scrollPerPage === !0 && e.currentItem > 0 && e.currentItem < e.options.items ? e.currentItem = 0 : e.currentItem -= e.options.scrollPerPage === !0 ? e.options.items : 1,
            e.currentItem < 0) {
                if (e.options.rewindNav !== !0)
        ...
        goTo: function(t, o, i) {
            var n, s = this;
            return s.isTransition ? !1 : ("function" == typeof s.options.beforeMove && s.options.beforeMove.apply(this, [s.$elem]),
            t >= s.maximumItem ? t = s.maximumItem : 0 >= t && (t = 0),
            s.currentItem = s.owl.currentItem = t,
            s.options.transitionStyle !== !1 && "drag" !== i && 1 === s.options.items && s.browser.support3d === !0 ? (s.swapSpeed(0),
            s.browser.support3d === !0 ? s.transition3d(s.positionsInArray[t]) : s.css2slide(s.positionsInArray[t], 1),
            s.afterGo(),
            s.singleItemTransition(),
            !1) : (n = s.positionsInArray[t],
            s.browser.support3d === !0 ? (s.isCss3Finish = !1,
            o === !0 ? (s.swapSpeed("paginationSpeed"),
            e.setTimeout(function() {
                s.isCss3Finish = !0
            }, s.options.paginationSpeed)) : "rewind" === o ? (s.swapSpeed(s.options.rewindSpeed),
            e.setTimeout(function() {
                s.isCss3Finish = !0
            ...
            s.transition3d(n)) : o === !0 ? s.css2slide(n, s.options.paginationSpeed) : "rewind" === o ? s.css2slide(n, s.options.rewindSpeed) : s.css2slide(n, s.options.slideSpeed),
            void s.afterGo()))
        },
        jumpTo: function(t) {
            var e = this;
        ...
        play: function() {
            ...
            t.options.autoPlay === !1 ? !1 : (e.clearInterval(t.autoPlayInterval),
        ...
        checkBrowser: function() {
            var t, e, o, i, n = this, s = "translate3d(0px, 0px, 0px)", a = document.createElement("div");
            a.style.cssText = "  -moz-transform:" + s + "; -ms-transform:" + s + "; -o-transform:" + s + "; -webkit-transform:" + s + "; transform:" + s,
        ...
        moveEvents: function() {
            var t = this;
            (t.options.mouseDrag !== !1 || t.options.touchDrag !== !1) && (t.gestures(),
            t.disabledEvents())
        },
        eventTypes: function() {
            var t = this
        ...
        gestures: function() {
            ...
            function n(e) {
                "on" === e ? (t(o).on(l.ev_types.move, a),
                t(o).on(l.ev_types.end, r)) : "off" === e && (t(o).off(l.ev_types.move),
                t(o).off(l.ev_types.end))
            }
            function s(o) {
            ...
            function a(n) {
                ...
                "function" == typeof l.options.startDragging && p.dragging !== !0 && 0 !== l.newRelativeX && (p.dragging = !0,
            ...
            function r(o) {
                ...
                l.goTo(i, !1, "drag"),
                p.targetElement === r.target && l.browser.isTouch !== !0 && (t(r.target).on("click.disable", function(e) {
                    e.stopImmediatePropagation(),
                    e.stopPropagation(),
                    e.preventDefault(),
        ...
        closestItem: function() {
            ...
            return t.each(o, function(s, a) {
                i - e.itemWidth / 20 > o[s + 1] && i - e.itemWidth / 20 < a && "left" === e.moveDirection() ? (n = a,
                e.options.scrollPerPage === !0 ? e.currentItem = t.inArray(n, e.positionsInArray) : e.currentItem = s) : i + e.itemWidth / 20 < a && i + e.itemWidth / 20 > (o[s + 1] || o[s] - e.itemWidth) && "right" === e.moveDirection() && (e.options.scrollPerPage === !0 ? (n = o[s + 1] || o[o.length - 1],
                e.currentItem = t.inArray(n, e.positionsInArray)) : (n = o[s + 1],
                e.currentItem = s + 1))
            }),
            e.currentItem
        },
        ...
        lazyLoad: function() {
            ...
            if (a.options.lazyLoad === !1)
                return !1;
            for (e = 0; e < a.itemsAmount; e += 1)
                o = t(a.$owlItems[e]),
                "loaded" !== o.data("owl-loaded") && (i = o.data("owl-item"),
                n = o.find(".lazyOwl"),
                "string" == typeof n.data("src") ? (void 0 === o.data("owl-loaded") && (n.hide(),
                o.addClass("loading").data("owl-loaded", "checked")),
                s = a.options.lazyFollow === !0 ? i >= a.currentItem : !0,
                s && i < a.currentItem + a.options.items && n.length && n.each(function() {
        ...
        completeImg: function(t) {
            var e;
            return t.complete ? (e = typeof t.naturalWidth,
            "undefined" !== e && 0 === t.naturalWidth ? !1 : !0) : !1
        },
        ...
        addItem: function(t, e) {
            ...
            !1) : (i.unWrap(),
            o = void 0 === e || -1 === e ? -1 : e,
            o >= i.$userItems.length || -1 === o ? i.$userItems.eq(-1).after(t) : i.$userItems.eq(o).before(t),
            void i.setVars()) : !1
        },
        removeItem: function(t) {
            var e, o = this;
            return 0 === o.$elem.children().length ? !1 : (e = void 0 === t || -1 === t ? -1 : t,
            o.unWrap(),
...
!function(t, e) {
    ...
    function t(t) {
        ...
        for (var r = Object.keys(t.breakAt), i = r.length - 1; i >= 0; i--) {
            ...
            e <= s && (o = t.breakAt[s],
            u(o) || (n.columns = o),
            u(o) && o.columns && (n.columns = o.columns),
            u(o) && o.margin && !u(o.margin) && (n.margin = {
                x: o.margin,
                y: o.margin
            }),
            u(o) && o.margin && u(o.margin) && o.margin.x && (n.margin.x = o.margin.x),
            u(o) && o.margin && u(o.margin) && o.margin.y && (n.margin.y = o.margin.y))
        }
        return n
    }
    function e(e) {
    ...
    function r(t, r) {
        var i = e(t.options)
          ...
          , a = void 0
          , c = void 0;
        return 1 === ++r ? 0 : (c = n(t.options).x,
        a = (c - (i - 1) * c / i) * (r - 1),
        s += o(t.options, !1) * (r - 1),
        "calc(" + s + "% + " + a + "px)")
    }
    function i(t) {
        for (var e = 0, n = t.container, o = t.rows, r = o.length - 1; r >= 0; r--)
            e = o[r] > e ? o[r] : e;
        n.style.height = e + "px"
    }
    function s(t, o) {
        ...
        o.forEach(function(e) {
            ...
            t.rows[n] += isNaN(o) ? 0 : o + c,
            s && (e.dataset.macyComplete = 1))
        }),
        s && (t.tmpRows = null),
        i(t)
    }
    function a(t, o) {
        ...
        o.forEach(function(e) {
            ...
            t.rows[t.lastcol] += isNaN(n) ? 0 : n + c,
            t.lastcol += 1,
            s && (e.dataset.macyComplete = 1))
        }),
        s && (t.tmpRows = null),
    ...
    Object.getOwnPropertyNames(Array.prototype).forEach(function(t) {
        "length" !== t && (NodeList.prototype[t] = Array.prototype[t],
        HTMLCollection.prototype[t] = Array.prototype[t])
    });
    ...
    var u = function(t) {
      ...
      , w = function t() {
        ...
        if (this.options = {},
        y(this.options, v, e),
        this.container = l(e.container),
        this.container instanceof l || !this.container)
            return !!e.debug && console.error("Error: Container not found");
        delete this.options.container,
        this.container.length && (this.container = this.container[0]),
...
function onStep(n, e) {
    function t() {
        ...
        $(".onStep:not(.animated)").each(function() {
            var t = $(this)
              , a = t.offset().top;
            n + e > a && (t.data("time") ? window.setTimeout(function() {
                t.addClass("animated " + t.data("animation"))
            }, parseInt(t.data("time"), 10)) : t.addClass("animated " + t.data("animation")))
        }),
        $(".onStep.animated").each(function(t) {
            var a = $(this)
              , i = a.offset().top;
            i > n + e && $(this).removeClass("animated fadeInUp flipInX flipInY lightSpeedIn hinge bounce flash pulse rubberBand shake swing tada wobble bounceIn bounceInDown bounceInLeft bounceInRight bounceInUp fadeIn fadeInDown fadeInDownBig fadeInLeft fadeInLeftBig fadeInRight fadeInRightBig fadeInUp fadeInUpBig flip rotateIn rotateInDownLeft rotateInDownRight rotateInUpLeft rotateInUpRight slideInDown slideInLeft slideInRight rollIn")
        })
    }
    var a = $win;
    1.1 * a.height();
...
// auto height content 2
function autoheight2() {
    var heights = new Array();

    // Loop to get all element heights
    $('.autoheight-2').each(function() {
        $(this).css('min-height', '0');
        $(this).css('max-height', 'none');
        $(this).css('height', 'auto');
        heights.push($(this).height());
...
// auto height content 3
function autoheight3() {
    var heights = new Array();

    // Loop to get all element heights
    $('.blog-simple .blog-text .heading a').each(function() {
        $(this).css('min-height', '0');
        $(this).css('max-height', 'none');
        $(this).css('height', 'auto');
        heights.push($(this).height());
...
// auto height content 4
function autoheight4() {
    var heights = new Array();

    // Loop to get all element heights
    $('.col2 .blog-simple .blog-text p').each(function() {
        $(this).css('min-height', '0');
        $(this).css('max-height', 'none');
        $(this).css('height', 'auto');
        heights.push($(this).height());

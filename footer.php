...
<script>
  document.addEventListener("DOMContentLoaded", function() { if(window.jQuery && window.jQuery.fn.revolution) { jQuery("#revolution-slider").revolution({ delay:5000, startwidth:1170, startheight:500, hideThumbs:10, fullWidth:"off", fullScreen:"on", fullScreenOffsetContainer: "" }); } });
</script>
...
@media (max-width: 768px) {
  .whatsapp-float {
    ...
    bottom: 40px;
    right: 20px;
    display: flex;                  /* <-- keep flex on mobile too */
    justify-content: center;
    align-items: center;
  }
}
...
.footer-phones .phone-list li { margin: 0; }
